...
-- Create shares view from compartilhamentos table
CREATE OR REPLACE VIEW public.shares AS
SELECT 
  id,
  usuario_id as user_id,
  conteudo_id as video_id,
  tipo_conteudo as content_type,
  plataforma_destino as platform,
  data_criacao as created_at,
  visualizacoes_compartilhamento as views_count,
  cliques_compartilhamento as clicks_count
