-- Insert test data into video_views (without creating auth users)
...
(gen_random_uuid(), (SELECT id FROM models LIMIT 1), 'whatsapp', '2025-08-10 09:00:00'),
(gen_random_uuid(), (SELECT id FROM models LIMIT 1 OFFSET 1), 'telegram', '2025-08-10 10:30:00'),
(gen_random_uuid(), (SELECT id FROM models LIMIT 1), 'facebook', '2025-08-10 11:15:00');
